...
Additionally, is it also possible to obtain a valid spatial arrangement of proteins that form entire cells or viruses via modeling software.
...
Erythrotytes (red blood cells) contain hemoglobin molecules so that \sfrac{2}{3} of their structure is made out of this one protein only. 
