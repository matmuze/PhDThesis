...
\begin{figure}
	\centering
	\includegraphics[width=0.85\linewidth]{graphics/goodsell_mitochondrion}
...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{graphics/cellpack}
\caption{The principle of cellPACK: first recipes are made based on available information acquired \textit{in vitro}, such as protein structures, concentrations, distribution and compartment. Then the software generates a plausible assemblage of molecules based on collision constraints in order to generate a larger structure featuring structural information down to the level of atoms, which would not be possible to acquire otherwise with traditional methods such as X-ray crystallography.}
\label{fig:cellpack}
\end{figure}
...
\caption{Pathway reaction cycle describing the process of energy production during aerobic respiration and which takes place in the mitochondria.}
...
The reaction network is denoted as pathway, an example is provided in Figure \ref{label}.
...
\begin{figure}
\centering
\includegraphics[width=0.99\linewidth]{graphics/figures-20160926T220833Z/figures/Teaser}
\caption{Playback of the trajectory data generated from MCell, and rendered in cellVIEW. The model was only designed for demonstration purposes and depicts a mitochondrion from outside (left) and inside (right). The models features channel proteins diffusing on the outer membrane of the organelle (red), and small ATP molecules (green) exiting the organelle through the channel proteins. The process which only is partially depicted here is the production of energy (ATP) in the core of the organelle that is then released outside the matrix in order to be consumed elsewhere in the cell.}
\label{fig:teaser}
\end{figure}
...
Indeed, the resulting visualization carry important information as it allows the depiction of complex biological systems in the form of 3D diffusion and reaction animations that can be embedded in their molecular environment, see Figure \ref{teaser}.
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{"graphics/large_scene"}
	\caption{Stress-test of the rendering achieved with a virtual dataset made out of 250 smaller blood plasma datasets, and comprising up to 15 billion atoms in total. The level-of-detail ensure a fast framerate when looking at the dataset entirely and the occlusion queries optimize the performance when closely looking at a sub-region of the dataset.}
...
\begin{figure}
\centering
\includegraphics[width=0.95\linewidth]{graphics/hiv}
\caption{Goodsell vs cellVIEW}
\label{fig:hiv}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=0.95\linewidth]{graphics/Picture10}
	\caption{Goodsell vs cellVIEW}
	\label{fig:hiv}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{graphics/Picture11}
...
A single bar comprises three distinct regions that indicate the visibility properties for a given species, as shown in Figure \ref{fig:visibility-equalizer}.
...
A screen-capture of the visibility equaliser is shown in
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=.99\linewidth]{"graphics/visibility equalizer"}
		\caption{}
		\label{fig:sub1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{graphics/figures-20160926T220833Z/figures/Apoptosis}
	\caption{Screenshot of frame m and m+3 of a molecular animation \textit{Apoptosis} made by Drew Berry~\ref{Apoptosis}. Mind how the main reaction is forced to remain fairly stationary
