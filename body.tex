...
Paper 1, 3, and 4 are co-authored by Julius Parulek who helped with the conception and implementation of the rendering pipeline, and he also provided valuable advices and support during the writing of manuscripts.
...
Paper 2 was co-authored by Ludovic Autin, who modified the cellPACK output data file to load in cellVIEW, he also helped designing the code to load the data in cellVIEW and he also provided essential support and insightful advices.
Paper 3 was co-authored by Peter Mindek as second first author since we deemed that both author contributed equally to the success of this article, this mention is also present in the publication.
Paper 3 also received additional help from Johannes Sorger for the writing of the manuscript, and the design choices were also influenced the feedback we received from Ludovic Autin and David S. Goodsell.
Paper 4 is also co-authored by Manuela Waldner who helped to design and run the user studies, provided insightful inspiration and also participated in the writing of the article. 
