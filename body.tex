...
%An event can be a reaction or, as in our demonstrational case, it could be an assisted transfer of a molecule through a membrane protein from one side of the membrane to the other side. 
...
\textbf{Filtering Redundant Information}
...
%Watching a scene of macromolecules, one can just see only the most frontal atoms.
...
The next operation of the pipeline is the visual mapping of the filtered elements which will determine visual properties such as shape, or color, and is a critical step to achieve expressiveness and effectiveness.
...
We have investigated how to guide the viewer to interesting events in a dense dynamic scene of interacting molecules that are presented on a large projection display. 
...
The rendering is probably the most crucial part of our visualization pipeline as it is meant to display challengingly large and dynamic molecular datasets.
